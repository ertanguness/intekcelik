                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Proje Durum Tanımla</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto float-end ms-auto">
                            <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_durum"><i class="fa-solid fa-plus"></i> Durum Ekle</a>
                        </div>
                    </div>
                </div>
                <!-- /Sayfa Başlığı -->
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Proje Durumu Ekle</h5>
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="input-block mb-3">
                                    ...
                                    <input class="form-control" type="text" name="durum_adi" id="durum_adi">
                                </div>
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Durum Rengi Seçiniz <span class="text-danger">*</span></label>
                                    <input class="form-control" type="color" name="durum_rengi" id="durum_rengi">
                                </div>
            ...
            <div id="edit_durum" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Proje Durumu Düzenle</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Kapat">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form>
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Durum Adı <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="edit_durum_adi" id="edit_durum_adi">
                                </div>
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Durum Rengi Seçiniz <span class="text-danger">*</span></label>
                                    <input class="form-control" type="color" name="edit_durum_rengi" id="edit_durum_rengi">
                                </div>
                                <div class="submit-section">
                                    <button class="btn btn-primary submit-btn">Kaydet</button>
                                </div>
