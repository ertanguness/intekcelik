                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Proje Kategori Tanımla</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto float-end ms-auto">
                            <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_kategori"><i class="fa-solid fa-plus"></i> Kategori Ekle</a>
                        </div>
                    </div>
                </div>
                <!-- /Sayfa Başlığı -->
                                    ...
                                    <tr>
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_kategori"><i class="fa-solid fa-pencil m-r-5"></i> Düzenle</a>
            ...
            <!-- durum Ekle Modal -->
            <div id="add_kategori" class="modal custom-modal fade" role="dialog">
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Kategori Adı <span class="text-danger">*</span></label>
            ...
            <!-- durum Düzenle Modal -->
            <div id="edit_kategori" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Ana Kategori Düzenle</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Kapat">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form>
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Kategori Adı <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="edit_kategori" id="edit_kategori">
                                </div>
